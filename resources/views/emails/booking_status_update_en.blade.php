...
<head>
    <meta charset="UTF-8">
    <title>Booking Status Update — GR Motors</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'Segoe UI', Arial, sans-serif; background: #f4f6f8; color: #333; direction: ltr; }
...
<div class="email-wrapper">
    ...
    <div class="hero">
        ...
        <div class="hero-title">Your booking status has been updated</div>
        <div class="hero-subtitle">Order No. #{{ $booking->id }}</div>
    </div>
    ...
    <div class="content">
        ...
        <p style="font-size:15px;color:#555;line-height:1.8;margin-bottom:20px;">
            We would like to inform you that your booking status has been updated as follows:
        </p>

        <!-- Status Change Visual -->
        <div class="status-change-box">
            <span class="status-pill status-old">
                {{ \App\Models\Booking::STATUSES_EN[$oldStatus]['label'] ?? $oldStatus }}
            </span>
            <span class="arrow">→</span>
            <span class="status-pill status-new">
                {{ \App\Models\Booking::STATUSES_EN[$newStatus]['label'] ?? $newStatus }}
            </span>
        </div>
        ...
        <div class="summary-card">
            ...
            <div class="summary-row">
                ...
                <span class="summary-value">{{ number_format($booking->monthly_installment) }} SAR</span>
            </div>
            @endif
            <div class="summary-row">
                <span class="summary-label">New Status</span>
        ...
        <div class="cta-wrapper">
            <a href="{{ route('store.account.orders') }}" class="cta-btn">View My Order Details</a>
        </div>
        @endif
    ...
    <div class="footer">
        ...
        <p class="footer-disclaimer">This email was sent automatically. Please do not reply directly.</p>
    </div>
